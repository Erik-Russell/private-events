...
ActiveRecord::Schema[8.0].define(version: 2024_11_16_162309) do
  ...
  create_table "attended_events", force: :cascade do |t|
    ...
    t.index ["attendee_id", "event_id"], name: "index_attended_events_on_attendee_id_and_event_id", unique: true
